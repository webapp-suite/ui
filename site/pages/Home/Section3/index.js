...
const dataList = [
    ...
    },
    {
        ...
        intro:
            'It has natural advantage of flexibility and easy combination, which is the cornerstone of the web app suite ui component library.',
    },
    {
    ...
    },
    {
        ...
        intro:
            'WebApp UI has built-in support for Markdown meanwhile support basic Markdown for specific components.',
    },
];
    ...
    <div className="home__section3" id="home__section3">
        ...
        <div className="home__section3-content">
            <div className="home__section3-content-title">
                <h2>WebApp suite ui component library features</h2>
            </div>
