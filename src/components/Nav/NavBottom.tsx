...
export default function NavBottom({ user, onSettingClick, onLogoutClick, hideSetting }) {
    return (
        <div className={`${prefixCls}-nav__bottom`}>
            ...
            <div className={`${prefixCls}-nav__bottom-user`}>
                <span className={`${prefixCls}-nav__bottom-user-name`}>{user?.name}</span>
                <span className={`${prefixCls}-nav__bottom-user-company`}>{user?.company}</span>
            </div>
