  ...
  render () {
    ...
    return (
      <Modal open={open} onClose={::this.onClose} lock>
        <ModalBody>
          <h3 className="earthui-avatar-clip__title">编辑头像</h3>
          <div className="earthui-avatar-clip__subtitle">调整头像尺寸和位置</div>
          <div className="earthui-avatar-clip__content">
            <div className="earthui-avatar-clip__edit">
              <AvatarEditor
            ...
            <div className="earthui-avatar-clip__zoom">
              ...
              <input
                ...
                step="0.01"
                defaultValue="1"
                className="earthui-avatar-clip__range-input"
              />
            ...
            <div className="earthui-avatar-clip__footer">
