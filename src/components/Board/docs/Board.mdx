...
```jsx vertical
import { Board, BoardHeader, BoardBody } from '@webapps-ui/core-react'
...
```jsx vertical
import { Board, BoardHeader, BoardBody, Button, notification } from '@webapps-ui/core-react'
...
```jsx vertical
import { Board, BoardHeader, BoardBody, Tabs, TabList, Tab, TabPanel } from '@webapps-ui/core-react'
